...
namespace
{
    ...
    [[nodiscard]] auto template_main_cpp(std::string_view package_id, std::string_view name)
        ...
        return "#include <nandina/app/nan_application.hpp>\n"
               ...
               "public:\n"
               "    auto route_key() const -> std::string_view override {\n"
               "        return \"main\";\n"
               "    }\n"
               "\n"
               "    auto build(app::PageContext& context) -> widget::View override {\n"
               "        return context.ui().make<widget::Label>(\"Hello, Nandina!\").build();\n"
               "    }\n"
               "};\n"
               "\n"
               "auto main() -> int {\n"
