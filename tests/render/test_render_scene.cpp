...
public:
    ThorvgCanvasScope(const std::uint32_t width, const std::uint32_t height)
        ...
        if (canvas_->target(pixels_.data(), width, width, height, tvg::ColorSpace::ARGB8888) != tvg::Result::Success) {
            canvas_.reset();
            tvg::Initializer::term();
...
TEST(RenderSceneTest, SceneCollectsCommands) {
    ...
    scene.push_rect(
            nandina::geometry::NanRect{nandina::geometry::NanPoint{4.0f, 6.0f}, nandina::geometry::NanSize{24.0f, 18.0f}},
            nandina::NanColor::from(nandina::NanRgb{10, 20, 30}))
        .push_rounded_rect(
            nandina::geometry::NanRect{nandina::geometry::NanPoint{30.0f, 10.0f}, nandina::geometry::NanSize{20.0f, 16.0f}},
            4.0f,
            4.0f,
            nandina::NanColor::from(nandina::NanRgb{40, 50, 60}))
        .push_text("A", 8.0f, 24.0f, 14.0f, nandina::NanColor::from(nandina::NanRgb{255, 255, 255}))
        .push_clip(nandina::geometry::NanRect{nandina::geometry::NanPoint{0.0f, 0.0f}, nandina::geometry::NanSize{16.0f, 16.0f}})
        .pop_clip();
...
TEST(RenderSceneTest, ThorVGAdapterRendersRectCommandsIntoCanvas) {
    nandina::render::Scene scene;
    scene.push_rect(
            nandina::geometry::NanRect{nandina::geometry::NanPoint{8.0f, 8.0f}, nandina::geometry::NanSize{20.0f, 20.0f}},
            nandina::NanColor::from(nandina::NanRgb{255, 0, 0}))
        .push_rounded_rect(
            nandina::geometry::NanRect{nandina::geometry::NanPoint{40.0f, 8.0f}, nandina::geometry::NanSize{20.0f, 20.0f}},
            6.0f,
            6.0f,
...
TEST(RenderSceneTest, ThorVGRenderBackendProvidesBeginSubmitPresentLoop) {
    ...
    nandina::render::Scene scene;
    scene.push_rect(
        nandina::geometry::NanRect{nandina::geometry::NanPoint{10.0f, 10.0f}, nandina::geometry::NanSize{16.0f, 16.0f}},
...
TEST(RenderSceneTest, ThorVGAdapterAppliesTopClipToSubsequentPaints) {
    nandina::render::Scene scene;
    scene.push_clip(
            nandina::geometry::NanRect{nandina::geometry::NanPoint{0.0f, 0.0f}, nandina::geometry::NanSize{8.0f, 8.0f}})
        .push_rect(
            nandina::geometry::NanRect{nandina::geometry::NanPoint{0.0f, 0.0f}, nandina::geometry::NanSize{20.0f, 20.0f}},
            nandina::NanColor::from(nandina::NanRgb{255, 0, 0}))
        .pop_clip();
