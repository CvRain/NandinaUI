...
| 模块层级 | 命名空间层级 | 示例 |
|----------|-------------|------|
| `nandina.<sub>` | `nandina::<sub>` | `nandina::foundation` |
| `nandina.<sub>.<module>` | `nandina::<sub>::<module>` | `nandina::geometry::NanPoint` |
...
| 子命名空间 | 职能说明 | 导出头文件 |
|------------|----------|-----------|
| `nandina::geometry` | 二维几何原语（点、尺寸、矩形） | `nan_point`、`nan_size`、`nan_rect` |
| `nandina::color` | 颜色值对象定义（内部使用） | `nan_color_schema`、`nan_color_converter` |
