...
Item {
    ...
    readonly property color _activeBarColor: ThemeManager.colors.primary.shade600
    ...
    readonly property color _bgColor: {
        ...
        if (_pressable.pressed)
            return ThemeManager.colors.surface.shade300;
        if (root.active)
            return ThemeManager.colors.primary.shade100;
        if (_pressable.hovered)
            return ThemeManager.colors.surface.shade200;
        return "transparent";
    }

    readonly property color _textColor: {
        if (!root.enabled)
            return ThemeManager.colors.surface.shade500;
        if (root.active)
            return ThemeManager.colors.primary.shade700;
        return ThemeManager.colors.surface.shade700;
    }

    readonly property color _iconBgColor: {
        if (root.active)
            return ThemeManager.colors.primary.shade200;
        return ThemeManager.colors.surface.shade200;
    }

    readonly property color _badgeBgColor: {
        if (root.active)
            return ThemeManager.colors.primary.shade300;
        return ThemeManager.colors.surface.shade300;
    }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Text {
                    ...
                    visible: root.iconSource.toString().length === 0
                    font.pixelSize: 13
                    color: root.active ? ThemeManager.colors.primary.shade700 : ThemeManager.colors.surface.shade700
                }
            }
            ...
            Rectangle {
                ...
                implicitHeight: 6
                radius: 3
                color: root.active ? ThemeManager.colors.primary.shade600 : ThemeManager.colors.surface.shade500
                Layout.alignment: Qt.AlignVCenter
            }
            ...
            Rectangle {
                ...
                Text {
                    ...
                    color: root.active ? "#ffffff" : ThemeManager.colors.surface.shade700
                }
            }
        }
