...
auto CardPage::build() -> app::NanComponent::Ptr {
    ...
    auto muted_text = [](std::string_view t) { return app::label(t).as_muted(); };
    ...
    return mount(
        column(
            children(
                ...
                flow(
                    children(sized_box(basic_card).width(500), sized_box(elevated_card).width(500))
                )
                    .gap(16)
                    .line_gap(16),
                ...
                flow(children(
                         sized_box(account_card).width(500),
                         sized_box(notification_card).width(500)
                     ))
                    .gap(16)
                    .line_gap(16),
