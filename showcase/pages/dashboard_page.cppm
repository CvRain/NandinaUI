...
export module nandina.showcase.overview_page;
...
namespace {
    ...
    auto make_label(std::string_view text, const float font_size,
        const NanColor& color) -> nandina::widgets::Label::Ptr {
    ...
    auto build_hero_surface() -> nandina::widgets::Surface::Ptr {
        ...
        pills->align_items(LayoutAlignment::center)
            .gap(10.0f);
        pills->add(make_pill("layout protocol active", color4_to_nancolor(64, 86, 124),
            color4_to_nancolor(228, 231, 244)));
...
public:
    [[nodiscard]] auto route_key() const noexcept -> std::string_view override { return "overview"; }
    [[nodiscard]] auto title()     const noexcept -> std::string_view override { return "Overview"; }
