    ...
    public:
        ...
        [[nodiscard]] auto build() -> nandina::app::NanComponent::Ptr override
        {
            ...
            auto checkboxes =
                column(
                    children(
                        ...
                        checkbox("Subscribe to newsletter").color_variant(ColorVariant::secondary).size(CheckboxSize::sm),
                        checkbox("Enable notifications").color_variant(ColorVariant::destructive).checked(true)
                    )
                )
                    .gap(8);
            ...
            return mount(center(column(children(
                                           ...
                                           semantic_tags,
                                           checkboxes,
                                           row(children(expanded(increase_button), expanded(decrease_button))).gap(12),
                                           row(children(spacer(), reset_button, spacer()))
                                       ))
                                    .gap(12)
