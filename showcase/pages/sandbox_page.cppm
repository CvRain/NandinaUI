...
export namespace nandina::showcase {
    ...
    public:
        ...
        [[nodiscard]] auto build() -> nandina::app::NanComponent::Ptr override {
            ...
            const auto white = nandina::NanColor::from(nandina::NanRgb{255, 255, 255});
            const auto muted = nandina::NanColor::from(nandina::NanRgb{154, 157, 180});
            ...
            auto heading = label("NandinaUI Sandbox")
            ...
            return mount(
                column(children(
                    sized_box(std::move(heading)).width(320),
                    std::move(btn_row)
                    ))
                .gap(16)
                .padding(24)
