...
namespace nandina::showcase {
    ...
    auto ButtonPage::build() -> app::NanComponent::Ptr {
        ...
        auto page_title = app::label().text("Button").style({
            .font_size   = 24,
        ...
        auto sizes_title = label("Sizes").style({
            .font_size   = 18,
            .font_weight = text::NanFontWeight::semiBold,
            .text_color  = NanColor::from(NanRgb{"#cdd6f4"}),
        });
        ...
        auto icon_examples = row(children(
                                     ...
                                     button("Sync")
                                         ...
                                         .icon_left(IconType::ArrowUp)
                                         .icon_right(IconType::ArrowDown)
                                 ))
                                 .gap(12);

        auto states_title = label("States").style({
            .font_size   = 18,
            .font_weight = text::NanFontWeight::semiBold,
            .text_color  = NanColor::from(NanRgb{"#cdd6f4"}),
        });
