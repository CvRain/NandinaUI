...
export namespace nandina::showcase {
    ...
    protected:
        void on_draw(tvg::SwCanvas& canvas) override {
            ...
            draw_rect(canvas, rect.x() + 6.0f, rect.y() + 24.0f, rect.width() - 12.0f, rect.height() - 30.0f, 60, 62,
                80, 150, 2);
        }
    ...
    protected:
        void on_draw(tvg::SwCanvas& canvas) override {
            ...
            draw_circle(canvas, rect.center().x(), rect.y() + rect.height() + 4.0f, 2.0f, rgb.red(), rgb.green(),
                rgb.blue(), 220);
        }
    ...
    private:
        DockBar() {
            ...
            auto icon_row = row(nandina::app::children(
                    adopt(DockIconItem::create(color4_to_nancolor(99, 102, 241), nandina::widgets::IconType::Circle,
                        true)),
                    adopt(DockIconItem::create(color4_to_nancolor(95, 200, 130), nandina::widgets::IconType::Dots,
                        true)),
                    adopt(DockIconItem::create(color4_to_nancolor(245, 158, 60), nandina::widgets::IconType::Triangle,
                        true)),
